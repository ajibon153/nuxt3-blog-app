...
Tutorial on learn NuxtJs 3 from youtube
https://www.youtube.com/watch?v=WoSIEdJmmBc

basic tutorial integration to localhost db node js in nuxt using useFetch and $fetch

# Tech used in this project app

Nuxt 3 : For Server Side Render Framework

Pinia : for state management

```bash
install pinia for nuxt
...
## Step to create this project app

Starting install Client Project

npm create nuxt@latest <project-name> -- -t v3

For the Server project is already created by the Tutor and can clone from here :

### server used for tutorial integration and basic routing
